...
class RecommandGoodsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_recommand_goods, container, false)
        val context = view.context

        updateItemList()

        val recyclerView = view.findViewById<RecyclerView>(R.id.recommand_recyclerview)
