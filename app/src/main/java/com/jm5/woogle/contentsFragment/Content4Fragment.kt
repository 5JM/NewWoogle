package com.jm5.woogle.contentsFragment
...
class Content4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_content4, container, false)
        val context = view.context

        updateItemList()

        val recyclerView = view.findViewById<RecyclerView>(R.id.content4_recyclerview)
