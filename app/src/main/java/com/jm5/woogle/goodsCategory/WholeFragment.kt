...
class WholeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_whole, container, false)
        val context = view.context

        updateItemList()

        val recyclerView = view.findViewById<RecyclerView>(R.id.whole_recyclerview)
    ...
    override fun onStart() {
        ...
        val test = 4523
        whole_counts.text= dec.format(test)
    }
