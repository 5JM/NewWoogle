...
import kotlinx.android.synthetic.main.fragment_wear.*
...
class WearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.wear_recyclerview)
    ...
    override fun onStart() {
        ...
        val test = 4523
        wear_counts.text= dec.format(test)
    }
