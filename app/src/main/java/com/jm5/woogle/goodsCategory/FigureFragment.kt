...
import kotlinx.android.synthetic.main.fragment_figure.*
...
class FigureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_figure, container, false)
    ...
    override fun onStart() {
        ...
        val test = 4523
        figure_counts.text= dec.format(test)
    }
