...
import kotlinx.android.synthetic.main.fragment_stationery.*
...
class StationeryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.stationery_recyclerview)
    ...
    override fun onStart() {
        ...
        val test = 4523
        stationery_counts.text= dec.format(test)
    }
